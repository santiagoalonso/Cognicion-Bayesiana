...
async function experimentInit() {
  ...
  ss_am = new visual.TextStim({
    ...
    font: 'Arial',
    units: undefined, 
    pos: [(- 0.5), 0.1], height: 0.1,  wrapWidth: undefined, ori: 0,
    color: new util.Color('white'),  opacity: 1,
    depth: -2.0 
  });
  ...
  Gracias = new visual.TextStim({
    win: psychoJS.window,
    name: 'Gracias',
    text: 'Terminaste!\n\nMuchas gracias por participar! \n\nOprime barra espaceadora para terminar',
    font: 'Arial',
    units: undefined, 
    pos: [0, 0], height: 0.1,  wrapWidth: undefined, ori: 0,
    color: new util.Color('white'),  opacity: 1,
...
function Inst1RoutineEnd() {
  return async function () {
    ...
    if (currentLoop instanceof MultiStairHandler) {
      currentLoop.addResponse(key1.corr, level);
    }
...
function Instr2RoutineEnd() {
  return async function () {
    ...
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
      currentLoop.addResponse(key2.corr, level);
    }
...
function Inst2_2RoutineBegin(snapshot) {
  return async function () {
    ...
    Inst2_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Inst2_2RoutineEachFrame() {
  return async function () {
...
function Inst2_2RoutineEnd() {
  return async function () {
    ...
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
      currentLoop.addResponse(key2_2.corr, level);
    }
...
function Inst2_3RoutineBegin(snapshot) {
  return async function () {
    ...
    Inst2_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Inst2_3RoutineEachFrame() {
  return async function () {
...
function Inst2_3RoutineEnd() {
  return async function () {
    ...
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
      currentLoop.addResponse(key2_3.corr, level);
    }
...
function Inst4RoutineEachFrame() {
  return async function () {
...
function Inst4RoutineEnd() {
  return async function () {
    ...
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
      currentLoop.addResponse(key4.corr, level);
    }
...
function PracticeLoopBegin(PracticeLoopScheduler, snapshot) {
  return async function() {
    ...
    Practice.forEach(function() {
      ...
      PracticeLoopScheduler.add(PractRoutineEachFrame());
      PracticeLoopScheduler.add(PractRoutineEnd());
      PracticeLoopScheduler.add(fb_PractRoutineBegin(snapshot));
      PracticeLoopScheduler.add(fb_PractRoutineEachFrame());
      PracticeLoopScheduler.add(fb_PractRoutineEnd());
...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    trials.forEach(function() {
      ...
      trialsLoopScheduler.add(ITCRoutineEachFrame());
      trialsLoopScheduler.add(ITCRoutineEnd());
      trialsLoopScheduler.add(fb_TrialsRoutineBegin(snapshot));
      trialsLoopScheduler.add(fb_TrialsRoutineEachFrame());
      trialsLoopScheduler.add(fb_TrialsRoutineEnd());
...
function PractRoutineBegin(snapshot) {
  return async function () {
    ...
    PractComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
var frameRemains;
function PractRoutineEachFrame() {
  return async function () {
    ...
    if (pregunta.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 0.0 + 20 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (ssAm_P.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 0.0 + 20 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (ssDel_P.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 0.0 + 20 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (llAm_P.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 0.0 + 20 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (llDel_P.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    if (respP.status === PsychoJS.Status.STARTED && t >= frameRemains) {
...
function PractRoutineEnd() {
  return async function () {
    ...
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
      currentLoop.addResponse(respP.corr, level);
    }
...
function fb_PractRoutineBegin(snapshot) {
  return async function () {
    ...
    fb_PractComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function fb_PractRoutineEachFrame() {
  return async function () {
    ...
    if (feedbackP.status === PsychoJS.Status.STARTED && t >= frameRemains) {
...
function Instr5RoutineEnd() {
  return async function () {
    ...
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
      currentLoop.addResponse(key5.corr, level);
    }
...
function ITCRoutineBegin(snapshot) {
  return async function () {
    ...
    ITCComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ITCRoutineEachFrame() {
  return async function () {
    ...
    frameRemains = 0.0 + 20 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (preguntaT.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 0.0 + 20 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (ssAm_T.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 0.0 + 20 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (ssDel_T.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 0.0 + 20 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (llAm_T.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 0.0 + 20 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (llDel_T.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 0.5 + 19.5 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (respT.status === PsychoJS.Status.STARTED && t >= frameRemains) {
...
function ITCRoutineEnd() {
  return async function () {
    ...
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
      currentLoop.addResponse(respT.corr, level);
    }
...
function fb_TrialsRoutineBegin(snapshot) {
  return async function () {
    ...
    fb_TrialsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function fb_TrialsRoutineEachFrame() {
  return async function () {
    ...
    frameRemains = 0.0 + 3 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (textfbT.status === PsychoJS.Status.STARTED && t >= frameRemains) {
