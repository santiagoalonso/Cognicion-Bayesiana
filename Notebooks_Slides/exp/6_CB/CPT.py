...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/santiagoalonsodiaz/OneDrive - Pontificia Universidad Javeriana/Clases/Cognicion Bayesiana/Notebooks_Slides/exp/6_CB/CPT.py',
...
Init_Instructions = visual.TextStim(win=win, name='Init_Instructions',
    text='Escoja la lotería que prefiera.\n\nOprima barra espaceadora para continua.',
    font='Arial',
...
for thisBlock_loop in block_loop:
    ...
    for thisTrial in trials:
        ...
        key_resp_3.rt = []
        _key_resp_3_allKeys = []
        image.size = [1.25*image.size[0], 1.25*image.size[1]]
